...
public class CarparkSummonApplication
       implements ExceptionListener
{
    ...
    public CarparkSummonApplication(String[] args)
    {
        parseArgs(args);
        ...
        /* print parameters */
        System.err.println("\n------------------------------------------------------------------------");
        System.err.println("CarparkSummonApplication");
        System.err.println("------------------------------------------------------------------------");
    ...
    void usage()
    {
        System.err.println("\nUsage: CarparkSummonApplication [options] [ssl options]");
        System.err.println("");
    ...
    {
        new CarparkSummonApplication(args);
    }
}
