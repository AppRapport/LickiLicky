...
public class AXSSubscriber
{
    ...
    public AXSSubscriber(String[] args) {
    ...
    {
        AXSSubscriber t = new AXSSubscriber(args);
    }

    void usage()
    {
        System.err.println("\nUsage: java AXSSubscriber [options]");
        System.err.println("");
